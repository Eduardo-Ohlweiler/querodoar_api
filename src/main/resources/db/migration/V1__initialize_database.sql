...
CREATE INDEX idx_user_active_verified ON public."user"(is_active, verified);
...
GROUP BY u.user_id, u.name, u.email, u.cell_phone, u.home_phone, u.whatsapp, u.is_active, u.verified, u.role, ling.experience, l.level, va.*;
